  ...
  records = [
    {
      ...
      type = "A"
      alias = {
        name                   = aws_cloudfront_distribution.cdn_multi_website["wallet"].domain_name
        zone_id                = aws_cloudfront_distribution.cdn_multi_website["wallet"].hosted_zone_id
        evaluate_target_health = false
      }
    },
    {
      name = "www.prod.wallet"
      type = "A"
      alias = {
        name                   = aws_cloudfront_distribution.cdn_multi_website["wallet"].domain_name
        zone_id                = aws_cloudfront_distribution.cdn_multi_website["wallet"].hosted_zone_id
