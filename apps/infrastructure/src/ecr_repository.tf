...
resource "aws_ecr_repository" "nextjs_image_repository" {
  name = "nextjs"
...
resource "aws_ecr_lifecycle_policy" "nextjs_policy" {
  repository = aws_ecr_repository.nextjs_image_repository.name
