...
variable "route53_zone_id" {
  description = "The ID of the existing Route 53 hosted zone for the custom domain. If not provided and custom_domain_name is set, a new hosted zone will be created."
  type        = string
  default     = null
}
