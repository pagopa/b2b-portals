...
| <a name="provider_aws.us-east-1"></a> [aws.us-east-1](#provider\_aws.us-east-1) | >= 5.16.2 |
...
| <a name="input_cors_allowed_origins"></a> [cors\_allowed\_origins](#input\_cors\_allowed\_origins) | List of allowed origins for CORS. If not provided, defaults to ['*']. | `list(string)` | <pre>[<br/>  "*"<br/>]</pre> | no |
...
| <a name="input_route53_zone_id"></a> [route53\_zone\_id](#input\_route53\_zone\_id) | The ID of the existing Route 53 hosted zone for the custom domain. If not provided and custom\_domain\_name is set, a new hosted zone will be created. | `string` | `null` | no |
...
| <a name="output_route53_zone_id"></a> [route53\_zone\_id](#output\_route53\_zone\_id) | The ID of the Route53 hosted zone (either existing or newly created). |
| <a name="output_route53_zone_name_servers"></a> [route53\_zone\_name\_servers](#output\_route53\_zone\_name\_servers) | The name servers for the Route53 zone (useful if a new zone was created). |
