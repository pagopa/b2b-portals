...
export const PressReleaseTemplate: StoryFn<PressReleaseProps> = (args) => <PressRelease {...args} />;

// Function to generate default props
const generateDefaultProps = (theme: 'light' | 'dark'): Partial<PressReleaseProps> => ({
  theme,
...
// Default props for light and dark themes
