...
import { TextPageProps } from '@react-components/types/TextPage/TextPage.types';
import { TextPage } from '@react-components/components';

// Define the default export with metadata about your component
const meta: Meta<typeof TextPage> = {
  title: 'Components/TextPage/Default',
  component: TextPage,
};
export default meta;

// Define a 'Template' function that sets how args map to rendering
const TextPageTemplate: StoryFn<TextPageProps> = (args) => (
  <TextPage {...args} />
);

export const TextPageFull: StoryFn<typeof TextPage> = TextPageTemplate.bind({});
TextPageFull.args = {
  title:
