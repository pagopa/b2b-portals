  ...
  data: [
    {
      ...
      attributes: {
        ...
        seo: {
          ...
          metaDescription:
            "Descrizione per l'homepage del sito vetrina di AppIO",
          keywords: null,
          canonicalURL: null,
          ogTitle: null,
          ogDescription: null,
...
describe('pressReleaseToPageDataArray', () => {
  it('prepend "press-releases" to all slugs', () => {
    ...
    const expected: ReadonlyArray<PageData> = [
      {
        seo: pressReleases.data[0]!.attributes.seo,
        sections: [
          {
            __component: 'sections.press-release',
            ...pressReleases.data[0]!.attributes.pressRelease,
          },
        ],
        slug: ['press-releases', 'art-2'],
      },
      {
        seo: pressReleases.data[1]!.attributes.seo,
        sections: [
          {
            __component: 'sections.press-release',
            ...pressReleases.data[1]!.attributes.pressRelease,
          },
        ],
