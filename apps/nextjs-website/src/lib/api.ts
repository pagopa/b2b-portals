...
export const getAllPages = async () => {
  ...
  const navigationApiUrl: string = 'http://localhost:1337/api/navigation';
  const token: string =
  ...
  try {
    ...
    const navigationRenderApiUrl: string = `http://localhost:1337/api/navigation/render/${navigationId}`;
