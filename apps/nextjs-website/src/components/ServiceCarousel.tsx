...
const serviceCarouselLabels: Record<Locale, ServiceCarouselProps['labels']> = {
  it: {
    ...
    slideOf: (index, total) => `${index + 1} di ${total}`,
  ...
  en: {
    ...
    slideOf: (index, total) => `${index + 1} of ${total}`,
  ...
  de: {
    ...
    slideOf: (index, total) => `${index + 1} von ${total}`,
  ...
  fr: {
    ...
    slideOf: (index, total) => `${index + 1} sur ${total}`,
  ...
  sl: {
    ...
    slideOf: (index, total) => `${index + 1} od ${total}`,
