...
resource "aws_s3_bucket_ownership_controls" "cms_medialibrary_owner" {
  bucket = aws_s3_bucket.cms_medialibrary_bucket.id
  rule {
...
resource "aws_s3_bucket_acl" "cms_medialibrary_acl" {
  depends_on = [
    aws_s3_bucket_ownership_controls.cms_medialibrary_owner,
    aws_s3_bucket_public_access_block.cms_medialibrary_bucket,
  ]
